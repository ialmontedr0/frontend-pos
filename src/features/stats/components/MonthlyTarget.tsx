...
export const MonthlyTarget: React.FC<MonthlyTargetProps> = ({
  target,
  progress,
  revenue,
  diffLastMonth,
        ...
        <div className="flex justify-between">
          <div>
            ...
            <p className="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
              Meta que debes alcanzar cada mes.
            </p>
          </div>
          <div className="relative inline-block">
            <button className="dropdown-toggle" onClick={toggleDropdown}>
              <MoreDotIcon className="text-gray-400 hover:text-gray-700 dark:text-gray-300 size-6" />
            </button>
