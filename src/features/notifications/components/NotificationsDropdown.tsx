...
export default function NotificationsDropdown() {
  ...
  return (
    <div className="relative">
      ...
      {unreadCount > 0 && (
        <span className="absolute top-0 right-0 -mt-1 -mr-1 flex h-5 w-5 items-center justify-center rounded-full bg-orange-400 text-xs text-white">
          {unreadCount}
        </span>
      )}
              ...
              >
                <span className="block">
                  ...
                  <span className="flex items-center gap-2 text-gray-500 text-theme-xs dark:text-gray-400">
                    ...
                    <span>{timeSince(notification.fecha)}</span>
                  </span>
                </span>
              </DropdownItem>
            </li>
