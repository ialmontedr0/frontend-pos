...
import { logout, clearAuth } from '../../features/auth/slices/authSlice';
  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center text-gray-700 dropdown-toggle dark:text-gray-gray-400"
      >
        <span className="mr-3 overflow-hidden rounded-[50%] w-11 h-11">
          <img
            src={
              user?.foto ||
